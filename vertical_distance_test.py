...
class HorizontalDistanceTest(unittest.TestCase):
    ...
    def setup_move_tests(self, sample_angle, heading, attribute_to_change, change_by):
        ...
        first_distance = point_locator.calculate_vertical_distance(distance, angle, first_data)
        second_distance = point_locator.calculate_vertical_distance(distance, angle, second_data)
